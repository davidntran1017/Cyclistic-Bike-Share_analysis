...
\* \*\*`merge\_cyclistic\_data.py`\*\* — Python script used to combine the 12 monthly trip datasets into a single CSV file.

\* \*\*`cyclistic\_analysis.sql`\*\* — SQL workflow used for data cleaning, feature engineering, analysis, and creation of Tableau summary tables.

\* \*\*`findings.md`\*\* — Detailed documentation of analysis results and insights produced throughout the SQL analysis.

\* \*\*`cyclistic\_dashboard.twb`\*\* — Tableau workbook containing the project's visualizations and final dashboard.
